...
3. [some **transcoding details**](#transcoding-details); and 
4. [the list of issues / to do](#ISSUES). 
...
```
- For issues and todo: [See below](#ISSUES_TRANSCODING_COMINT)
- `Indic.Congén.` := Intervention due to a birth defect (congenital disorder)

## 4. Issues / to do<a name="ISSUES"></a> 

1. [EuroScore too high: Due to transcoding of COMINT](todo/2019-03-18_COMINT_EUROSCORE.md)? <a name="ISSUES_TRASCODING_COMINT"></a>
2. [Missing values in EuroScore](todo/2019-03-18_COMPUTED_EUROSCORE_IS_NULL.md)
3. [Possibly under-reported complications](todo/2019-03-18_COMPLICATIONS_AT_15D.md)
4. [The aggregated number of complications equals zero all the time, despite the fact that some complications are being reported](todo/2019-06-27_COMPLICATIONS.md)
